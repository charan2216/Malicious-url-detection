...
#Loading the model
file_path_model = "E:/Gopal/malware detection/Classifier/pickel_model.pkl"
file_path_vectorizer = "E:/Gopal/malware detection/Classifier/pickel_vector.pkl"

with open(file_path_model, 'rb') as f1:  
    lgr = pickle.load(f1)

with open(file_path_vectorizer, 'rb') as f2:  
